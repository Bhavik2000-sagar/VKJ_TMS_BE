...
const SUPPORTER_ACTIONS = ["task.update", "meeting.manage", "report.view"];
/** Stable codes for tenant hierarchy roles (Add user form). */
export const TENANT_ASSIGNABLE_ROLE_CODES = [
    "ADMIN",
    "VP_GM",
    "MANAGER",
    "STAFF",
...
async function wireRolePermissions(roleId, actions, byAction) {
 ...
 */
export async function ensureTenantHierarchyRoles(tenantId) {
